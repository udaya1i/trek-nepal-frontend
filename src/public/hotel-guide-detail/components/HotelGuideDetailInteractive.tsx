...
const HotelGuideDetailInteractive: React.FC = () => {
  const [data, setData] = useState<HotelGuideDetailData | null>(null);
  ...
  if (!data) {
    return <div className="p-8">Loading hotel/guide details...</div>;
  }
